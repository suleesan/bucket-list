...
const BucketListItem = ({
  ...
  const { getComments, getUsersByIds, deleteComment, addComment } = useDatabase();
          ...
          >
            <Box>
              ...
              >
                ...
                Added by {item.created_by === currentUser.id ? "me" : (creator?.username || "Unknown")}
              </Typography>
              {(() => {
                ...
                if (upvotes?.length > 2 && upvArr[0]?.username) {
                  return (
                    ...
                    >
                      ...
                      {upvotes.length - 1 === 1 ? " person" : " people"} are going
                    </Typography>
                  );
                }
                return null;
          ...
          <Box sx={{ mb: 3 }}>
              ...
              <Button
                ...
                sx={{
                  color: item.upvotes?.includes(currentUser.id)
                    ? "primary.main"
                    : "text.primary",
                  borderColor: item.upvotes?.includes(currentUser.id)
                    ? "primary.main"
                    : "text.primary",
                  "&:hover": {
                    backgroundColor: item.upvotes?.includes(currentUser.id)
                      ? "rgba(0, 0, 0, 0.04)"
                      : "rgba(0, 0, 0, 0.04)",
                  },
                }}
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                <Box sx={{ display: "flex", alignItems: "center", minWidth: "120px", color: "text.secondary", gap: 0.5 }}>
              ...
              <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                ...
                <Typography variant="body2">
                  {item.created_by === currentUser.id ? "You" : (creator?.username || "Unknown")}
                </Typography>
              </Box>
                ...
                <Box sx={{ display: "flex", alignItems: "flex-start", mb: 2 }}>
                  ...
                  <Box>
                    {upvoters[item.id].map((user, index) => (
                      <Typography key={user.id} variant="body2" component="span">
                        {user.username}
                      ...
                      >
                        <Typography variant="body2" sx={{ color: "white", fontWeight: "bold" }}>
                          {comment.created_by === currentUser.id 
                            ...
                            : (localCommentUsers?.[comment.created_by]?.username?.charAt(0).toUpperCase() || "U")
                          }
                        </Typography>
                      </Box>
                      <Box sx={{ flexGrow: 1 }}>
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 0.5 }}>
                          <Typography variant="body2" sx={{ fontWeight: 500 }}>
                            {comment.created_by === currentUser.id ? "You" : (localCommentUsers?.[comment.created_by]?.username || "Unknown")}
                          </Typography>
